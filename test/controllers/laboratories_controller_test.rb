...
class LaboratoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratory" do
    assert_difference("Laboratory.count") do
      post laboratories_url, params: { laboratory: { location: @laboratory.location, name: @laboratory.name } }
    end
  ...
  test "should update laboratory" do
    patch laboratory_url(@laboratory), params: { laboratory: { location: @laboratory.location, name: @laboratory.name } }
