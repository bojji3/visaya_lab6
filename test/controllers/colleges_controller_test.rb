...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference("College.count") do
      post colleges_url, params: { college: { location: @college.location, name: @college.name } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { location: @college.location, name: @college.name } }
